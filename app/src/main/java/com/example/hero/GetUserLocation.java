...
public class GetUserLocation extends AppCompatActivity {
    ...
    TextView latTextView, lonTextView,aaTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aaTextView = findViewById(R.id.aaTextView);
                        ...
                        new OnCompleteListener<Location>() {
                            ...
                            public void onComplete(@NonNull Task<Location> task) {
                                ...
                                if (location == null) {
                                    ...
                                    endPoint.setLatitude(19.086029);
                                    endPoint.setLongitude(72.830343);
    ...
    private LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            //Toast.makeText(GetUserLocation.this, "im here", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    /*public void hi(View view) {
        startActivity(new Intent(this, AAAA.class));
